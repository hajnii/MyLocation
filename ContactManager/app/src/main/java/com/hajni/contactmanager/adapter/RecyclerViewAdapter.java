package com.hajni.contactmanager.adapter;
...
import com.hajni.contactmanager.R;
import com.hajni.contactmanager.UpdateContact;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    i.putExtra("phone",phone); // 이름을정해서 보낸다
